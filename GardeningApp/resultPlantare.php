...
$user_data = check_login($con);
    ...
    $q8 = $_POST['q8'];
		...
		echo ' <center><button class="button" style="vertical-align:middle"><span><a href="Floriplantare.php">Chestionar pentru cursul 5</a></span></button></center>';
		}
		else {
		...
		$idtest=$user_data['id_plantare'];
		$idtest=$idtest +1;
		$sql = "UPDATE Users SET id_plantare = '$idtest' WHERE user_id =$id";
