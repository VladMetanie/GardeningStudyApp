...
$user_data = check_login($con);
    ...
    $q8 = $_POST['q8'];
		...
		echo ' <center><button class="button" style="vertical-align:middle"><span><a href="Ingrijirea_solului.php">Chestionar pentru cursul 3</a></span></button></center>';
		}
		else {
		...
		$idtest=$user_data['id_ingrijire'];
		$idtest=$idtest +1;
		$sql = "UPDATE Users SET id_ingrijire = '$idtest' WHERE user_id =$id";
